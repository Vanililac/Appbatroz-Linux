...
namespace Appbatrozlinux
{
    class bookmark : Window
    {
       ...
       if (!File.Exists(folder + "/appbatrozlnx/appbatroztext/" + "bmrk.txt"))
          {
                System.IO.FileInfo file = new System.IO.FileInfo(folder + "/appbatrozlnx/appbatroztext/");
               file.Directory.Create();

                FileStream fs = new FileStream(folder + "/appbatrozlnx/appbatroztext/" + "bmrk.txt", FileMode.CreateNew);
